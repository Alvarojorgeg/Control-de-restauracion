...
<img src="./img/volver.png" class="base_cerrarpes" alt="Cerrar" onclick="window.history.back()">
    <div class="config_base2">
        <div class="config_base4"><h1 class="mesa_h1">MENU DE SISTEMA</h1></div>
        <div class="config_base5">
            <div class="config_base3">
                <a href="mesa.php">
                    <div class="config_bmenu">
                        <img src="./img/mesas.png" width="150px">
                        <h2 class="config_p">Mesas</h2>
                    </div>
                </a>
                <a href="cocina.php">
                    <div class="config_bmenu">
                        <img src="./img/cocina.png" width="150px">
                        <h2 class="config_p">Cocina</h2>
                    </div>
                </a>
            </div>
        </div>
